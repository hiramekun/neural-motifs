...
def _sel_rels(ious, pred_boxes, pred_labels, gt_classes, gt_rels, fg_thresh=0.5,
              fg_rels_per_image=128, num_sample_per_gt=1, filter_non_overlap=True):
    """
...
def _sel_inds(ious, gt_classes_i, fg_thresh=0.5, fg_rois_per_image=128, rois_per_image=256,
              n_sample_per=1):
